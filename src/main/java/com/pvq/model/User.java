...
public class User {
    ...
    // ✅ Đổi role từ String → Enum để kiểm soát phân quyền
    @Enumerated(EnumType.STRING)
    private Role role = Role.ROLE_USER; // mặc định là ROLE_USER
    ...
    // 1 User có nhiều PaymentInformation
    @Embedded
    @ElementCollection
    @CollectionTable(
    ...
    // thời điểm tạo User (tự động set khi tạo)
